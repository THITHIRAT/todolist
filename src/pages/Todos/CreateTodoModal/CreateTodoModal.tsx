...
interface ICreateTodoModal {
  ...
  onCreateSubmit: (data: ITodo) => void
}
const CreateTodoModal = ({ setIsCreateModalOpen, onCreateSubmit }: ICreateTodoModal) => {
  return (
    <div
    ...
    >
      <div role="alert" className="container mx-auto w-5/6 lg:w-2/3 max-w-lg">
        <div className="relative py-6 px-4 bg-background shadow-md rounded">
          <CreateTodoForm setIsCreateModalOpen={setIsCreateModalOpen} onSubmit={onCreateSubmit} />
        </div>
      </div>
    </div>
  );
